...
def draw_day_clock(draw, current_time, center_x, center_y, size):
    ...
    if bDrawNumbers:
        ...
        for i in range(1,13):
            ...
            number_radius = int(face_radius * 0.1)
            draw.ellipse((hour_x-number_radius, hour_y-number_radius, hour_x+number_radius, hour_y+number_radius), fill=epd_GRAY1) #, outline=epd_GRAY4, width=1) # fill=epd_GRAY1)
...
def draw_year_clock_with_weeks(draw, current_time, center_x, center_y, size):
    ...
    if bDrawMonths:
        ...
        for i in range(12):
            ...
            number_radius = int(face_radius * 0.125)
            draw.ellipse((month_x-number_radius, month_y-number_radius, month_x+number_radius, month_y+number_radius), fill=epd_GRAY1) #, outline=epd_GRAY4, width=1) # , fill=epd_GRAY1)
...
def draw_frame( draw ):
    draw.text((10, 20), 'Year Clock - 2025 - Adrian Ferrier', font = font24, fill = 0)
